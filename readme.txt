...
* 1.1 - Adding error message connecting with the Yahoo! Weather server
* 1.0 - Yahoo! Weather reader
...
2. Preview error message connecting
3. Preview in WordPress Administration area